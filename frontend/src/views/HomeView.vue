...
<template>
	<main>
		<div id="slide1" class="slide">
			...
			<h1>
				{{ $t("home.slide1.part0") }}
				<span class="hl">{{ $t("home.slide1.part1") }}</span> <br />{{ $t("home.slide1.part2") }} <br />{{
					$t("home.slide1.part3")
				}}
		...
		<div id="slide2" class="slide">
			...
			<h1 class="ar">
				...
				>, <br />{{ $t("home.slide2.part2") }} <span class="hl">{{ $t("home.slide2.part3") }}</span> <br />{{
					$t("home.slide2.part4")
				}}
			</h1>
		</div>
		...
		<div id="slide4" class="slide" v-show="state.didClick">
			<div class="contact-text">
				<h1 v-if="state.hasWebsite" class="ct">
					You are <span class="hl">on the right track</span> to get <span class="hl">new clients</span>.
					<br />In case you need to <span class="hl">improve</span> and <span class="hl">modernize</span> it,
					or <span class="hl">make it more pretty</span>, do not hesitate to
					<span class="hl">contact us</span> via the form below and we will agree on the details.
				</h1>
				<h1 v-else class="ct">
					You are in the right place! <br /><span class="hl">Contact us</span> via the form below <br />and we
					will <span class="hl">agree</span> on the details.
				</h1>
			</div>
