...
export default function useValidator(email, message, emailErrors, messageErrors, validatorFirstRun) {console.log("validator");

    if(validatorFirstRun.value) {console.log("validator fires on change");
        return;
    }
